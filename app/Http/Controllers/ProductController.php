...
class ProductController extends Controller
{
    ...
    public function bajuPria()
    {
        ...
        return view('products.baju-pria', compact('products'));
    }

    public function celanaPria()
    {
        $products = Product::where('category_id', 2)->paginate(9);
        return view('products.celana-pria', compact('products'));
    }

    public function bajuWanita()
    {
        $products = Product::where('category_id', 3)->paginate(9);
        return view('products.baju-wanita', compact('products'));
    }

    public function celanaWanita()
    {
        $products = Product::where('category_id', 4)->paginate(9);
        return view('products.celana-wanita', compact('products'));
    }
}
